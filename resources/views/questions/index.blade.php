    ...
    <div class="collapse navbar-collapse" id="navbarCollapse">
      <ul class="navbar-nav mr-auto">
        ...
        <li class="nav-item">
          ...
          <a class="nav-link" href="{{ route('myquestion') }}" action="GET">質問履歴</a>
        </li>
        <li class="nav-item">
...
<main role="main" >
  <div class="jumbotron">
    <h1 class="display-4">skill.hub</h1>
  ...
  <div class="container mt-5">
    <div class="row">
      <div class=" col-10 pt-3  bg-white rounded shadow-sm">
          <!-- <h6 class="border-bottom border-gray pb-2 mb-0">Recent updates</h6> -->
          @isset($search_result)
            <h1>{{ $search_result }}</h1>
          @endisset
          <h6 class="border-bottom border-gray pb-2 mb-0">新着質問</h6>
          @foreach($questions as $question)
            <div class="media text-muted pt-3">
              ...
              <p class="card-text"><small class="text-muted">{{ $question['updated_at'] }}</small></p>
            </div>
          @endforeach
          {{ $questions->links() }}
      </div>
